...
\section{Analisi del merge distribuito}

\subsection{Casi confrontati}

Negli esperimenti di merge il criterio interpretativo è separato in tre classi:
\begin{itemize}
    \item \texttt{valid}: merge semanticamente corretta in modo diretto;
    \item \texttt{invalid}: merge non semanticamente corretta;
    \item \texttt{recoverable}: merge non corretta in modo diretto ma
...
\section{Merge eterogeneo: casi \texttt{invalid}}
...
medio del merge e del riferimento seriale.
La colonna finale riporta invece il degrado medio, cioè la media del rapporto
punto per punto tra errore del merge ed errore del riferimento seriale.
...
Nei casi \texttt{invalid}, il merge forzato non produce una semplice perdita
...
senza introdurre un merge semanticamente scorretta.

\section{Merge eterogeneo: casi \texttt{recoverable}}
...
coincidenza tra stima da merge e riferimento seriale.
...
\subsection{Degrado del merge forzato nel caso \texttt{recoverable}}

Senza normalizzazione, il merge forzato mostra un degrado marcato:
\begin{itemize}
