...
Gli esperimenti sugli algoritmi sono organizzati in due gruppi complementari.
  ...
  \rho_t=\frac{t}{F_0(t)}
  \]
  in modo da separare, per quanto possibile, l'effetto della crescita degli elementi distinti
...
\subsection{Analisi sulla variazione dei parametri degli algoritmi}
...
Affinch\'e si possano fare degli esperimenti nel caso di merge omogeneo, \`e
necessario effettuare il merge mantenendo identici funzione di hash, seed e parametri dell'algoritmo.
...
\subsubsection{Hash mismatch}
  ...
  Da questo esperimento ci si aspetta sicuramente una degradazione della stima; 
...
e che venga trattato come merge recuperabile dai casi in cui il
  ...
  \begin{figure}[htbp]
      ...
      \begin{subfigure}[t]{0.98\textwidth}
          \centering
          \includegraphics[width=\linewidth]{figures/results/merge_hpp_precision_mismatch_recoverable_full_overview.pdf}
