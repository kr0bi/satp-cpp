...
\begin{itemize}
    ...
    \item $\hat{\theta}$: stimatore o stima della quantità $\theta$.
    ...
    \item $\Delta_{abs}$: differenza assoluta tra stima da fusione e riferimento seriale.
    \item $\Delta_{rel}$: differenza relativa tra stima da fusione e riferimento seriale.
    \item $D$: rapporto di degrado tra errore della fusione ed errore del riferimento seriale, valutato punto per punto e poi mediato sui casi osservati.
