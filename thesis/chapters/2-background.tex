...
\begin{itemize}
    \item Definizione di hash e proprieta' desiderate.
    \item Assunzioni tipiche: uniformita', indipendenza (o hash quasi-uniformi).
    \item Impatto di scelte non ideali sull'errore degli stimatori.
    \item Eventuale gestione del seed per riproducibilita'.
\end{itemize}
...
\section{Stimatori}
Si descrive cosa si intende per stimatore e in che senso la stima e' corretta. Da completare:
\begin{itemize}
    \item Definizione di stimatore $\hat{F}_0$ e proprieta' desiderate.
...
Questa sezione introduce le metriche di qualita' della stima. Da completare:
\begin{itemize}
